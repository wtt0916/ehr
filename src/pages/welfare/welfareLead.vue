        ...
        <div class="import-file">
            ...
            <div class="comm">
                <el-breadcrumb class="bread" separator="/">
                    ...
                    <el-breadcrumb-item>
                        <a href="/welfareParameter">历史台账</a>
                    </el-breadcrumb-item>
                    <el-breadcrumb-item>
                        <a>导入历史台账</a>
                    </el-breadcrumb-item>
            ...
            <div class="import_mes">
                ...
                <template v-if="active==1">
                    ...
                    <div class="pick-model">
                        <el-table :data="datas" border height="140" style="width: 100%">
                            <el-table-column prop="date" label="固定薪资" width="380">
                                <template slot-scope="scope">
                                    ...
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-button class="import-btn" @click="onCustom(scope.row)"><i
                                            class="el-icon-plus"></i>自定义
                                    </el-button>
                                </template>
                            </el-table-column>
                            <el-table-column prop="name" label="浮动薪资" width="380">
                                <template slot-scope="scope">
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">岗位薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                            ...
                            <el-table-column prop="address" label="津补贴" width="380">
                                <template slot-scope="scope">
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">岗位薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                            ...
                            <el-table-column prop="address" label="薪资扣减项" width="380">
                                <template slot-scope="scope">
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">岗位薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                            ...
                            <el-table-column prop="address" label="社保缴纳项" width="380">
                                <template slot-scope="scope">
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">岗位薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                            ...
                            <el-table-column prop="address" label="公积金缴纳项" width="380">
                                <template slot-scope="scope">
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">岗位薪资</el-checkbox>
                                    <el-checkbox class="import-item" v-model="checked">基本薪资</el-checkbox>
                    ...
                    <div class="file-upload">
                        ...
                        <div>
                            <el-upload ref="uploadfile" class="upload-import"
                                action="https://jsonplaceholder.typicode.com/posts/" :on-success="handleSuccess"
                                :on-progress="handleProcess" :on-change="handleChange" :on-error="handleError"
                                :on-exceed="handleExceed" :before-remove="beforeRemove" :multiple="false">
                                <el-input v-model="fileList[0].name" class="uploat-show-input"></el-input>
                                <el-button class="btn-upload" size="small">选择文件</el-button>
                                <el-button v-if="isUploading" class="next-step" slot="tip" type="primary" size="small">上传中<i
                                        class="el-icon-loading"></i></el-button>
                                <el-button v-if="isShowNextBtn" class="next-step" slot="tip" type="primary" size="small"
                ...
                <!--弹框区域-->
                <el-dialog class="zy-dialog-pub zy-dialog-pub-large custom-item" title="自定义公积金缴纳项"
                    :visible.sync="isShowCustom">
                    <div class="head-body">
                        <div v-for="(itemname,$index) in itemnameList" class="item">
                            ...
                            <el-button class="dia-btn-add-custom" v-if="itemnameList.length-1 == $index" icon="el-icon-plus"
                                @click="handleContinueAdd">继续添加</el-button>
                        </div>
