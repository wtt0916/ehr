<template>
    <el-dialog title="复职" :visible="reinstateVisible" @update:visible="v=>$emit('update:reinstateVisible',v)"
        class="reinstate">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
            <el-row class="contract">
                <el-col :span="12">
                    <el-form-item label="复职日期：" required>
        ...
        <div slot="footer" class="dialog-footer">
            <el-button @click="$emit('update:reinstateVisible',false)">取 消</el-button>
            <el-button type="primary" @click="reinstateSuccess">确 定</el-button>
        </div>
    </el-dialog>
</template>
...
<script>
    export default {
        ...
        methods: {
            reinstateSuccess() {
                this.$emit('update:reinstateVisible', false);
                console.log("续签成功");
            }
        }
